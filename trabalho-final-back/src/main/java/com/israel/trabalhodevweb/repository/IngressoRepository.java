...
public interface IngressoRepository extends JpaRepository<Ingresso, Long> {
    ...
    @Query(
            value = "select i from Ingresso i left join fetch i.sessao s where s.horaInicio=:horaInicio order by i.assento asc",
    ...
    @Query(
            ...
            value = "select i from Ingresso i left join fetch i.sessao order by i.assento asc",
